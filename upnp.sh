...
# 参数与默认值
Public_addr="${1:-192.168.1.100}"    # 默认公网地址（如果需要可改）
Public_port="${2:-8080}"             # 默认外部端口
IP4P="${3:-192.168.1.100}"           # 默认内网IP
Bind_port="${4:-8080}"               # 默认绑定端口
Protocol="${5:-TCP}"                 # 默认协议
Private_addr="${6:-192.168.1.100}"   # 默认私网地址
